...
async def test_inference_server(logger, args):
    prompt = args.prompt
    ...
    try:
        ...
        response = await client.generate(prompt, max_new_tokens=_LLM_MAX_OUTPUT_TOKENS, top_p=_LLM_TOP_P,top_k=_LLM_TOP_K,temperature=_LLM_TEMPERATURE)
...
if __name__ == "__main__":
    ...
    asyncio.run(test_inference_server(logger, arguments))
